...
namespace BTL
{
    ...
    {
<<<<<<< HEAD
        string strConnect = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""E:\tuyet beo\Lập trình trực quan\BAI TAP\BTLC-\BTL\BTL\DataBase\DuLieu.mdf"";Integrated Security=True";
=======
