...
namespace BTL
{
    ...
    {
        string strConnect = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\anhtu\OneDrive\Documents\GitHub\BTLC-\BTL\BTL\DataBase\DuLieu.mdf;Integrated Security=True" + System.IO.Directory.GetCurrentDirectory().ToString() + "\\DataBase\\" + "DuLieu.mdf;Integrated Security=True";
