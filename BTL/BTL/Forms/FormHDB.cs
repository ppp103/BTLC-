...
namespace BTL
{
    public partial class FormHDB : Form
    {
        ...
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""C:\Users\Dell Mediamart\source\repos\ppp103\BTLC-\BTL\BTL\DataBase\DuLieu.mdf"";Integrated Security=True");
        SqlCommand cmd;
        SqlDataReader dr;
        string sql,sql1;
